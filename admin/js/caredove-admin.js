	...
	'use strict';
        ...
        function do_button_style() {          
            ...
            if(thestyles != null){
              ...
              var svgIcon = '';
              console.log($('.mce-title').text());
              if($('.mce-title').text() == 'Add a Caredove Search Page'){
                ...
                style_name += ' caredove-button-with-icon';
              } 

             

              var button = '<button type="button" class="caredove-inline-link caredove-styled-button '+style_name+'" style="'+style_inline+'">'+button_text+svgIcon+'</button>';
