...
= 0.6.9=
* Fixing issue where empty $listings object would cause multiple attempts to connect with faulty credentials

= 0.6.8=
* Fixing warning on site for meta tag

= 0.6.7=
* Fixing warning on site for meta tag

= 0.6.6=
* Issue with Pop up width change in css for that 
...
= 0.5.9=
* Made popup lists scrollable in TinyMCE
* Fixed error that was causing listings not to refresh when pulling from API
* Set Transient refresh interval to 2 hrs
...
= 0.5.4=
* added default colour of white #ffffff to Search button icon for when colour was not specified
* updated url prefixes to use launch. prefix

= 0.5.3=
* fixing issue with iframe field not hiding and showing properly
* fixing issue that caused search button icon not to be same as text colour

= 0.5.2=
* change height, to style height for iFrame height

= 0.5.1=
* added option to embedded search page for iFrame height
* fixed issue where open modal was scrolling window to top
